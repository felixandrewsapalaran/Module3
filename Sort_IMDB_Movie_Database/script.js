 ...
 function sortMoviesByRank(movies){
    // Code from previous sortBestRatingsFirst() function
      for (let j = 0; j < movies.length - 1; j++) {
        ...
        /*
        This is the first index of the object we a looping first value
        {
            title: "Fight Club",
            rank: 10,
            id: "tt0137523"
        ...
        */
          ...
          for (let i = j + 1; i < movies.length; i++) {
            ...
            /*
                Comparing the rank of movies and object
            ...
            */
              if (movies[i].rank > max_obj.rank) {
                  ...
                  // if we found oject with higher rank, then replace max_obj with the new object
                  max_obj = movies[i] // at certain index we're saving new object again whichever is greater
                  max_location = i
              }
          }
...
function sortMoviesByAttr(movies, sortAttr){
  ...
  for (let j = 0; j < movies.length - 1; j++){
      let max_obj = movies[j];
      let max_location = j;
      // j is our starting index from our outer loop 
      let max = getMaxMovieObject(movies, j, sortAttr)
      // get the max movie object
      max_obj = max.max_obj;
      // gets its index location
